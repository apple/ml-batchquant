...
from qfa.elastic_nn.modules.dynamic_layers import DynamicMBConvLayer, DynamicConvLayer, DynamicLinearLayer
from qfa.layers import ConvLayer, IdentityLayer, LinearLayer, MBInvertedConvLayer
from qfa.imagenet_codebase.networks.mobilenet_v3 import MobileNetV3, MobileInvertedResidualBlock
from qfa.imagenet_codebase.utils import make_divisible, int2list
...
class OFAMobileNetV3(MobileNetV3):
    ...
    def set_sandwich_subnet(self, mode):
        ...
        ks_setting = random.choice(self.ks_list)  # aggregate(self.ks_list)
